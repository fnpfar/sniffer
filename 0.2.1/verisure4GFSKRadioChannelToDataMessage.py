...
# Title: Verisure 4GFSK Radio Channel to Data Mesagge
...
import sys
import signal
import verisure4GFSKRadioChannelToDataMessage_verisure_crc_checker as verisure_crc_checker  # embedded python block
import verisure4GFSKRadioChannelToDataMessage_verisure_float_to_msg_resamp_ratio_converter as verisure_float_to_msg_resamp_ratio_converter  # embedded python block
import verisure4GFSKRadioChannelToDataMessage_verisure_tagged_bitstream_to_pdu as verisure_tagged_bitstream_to_pdu  # embedded python block
...
class verisure4GFSKRadioChannelToDataMessage(gr.hier_block2):
    def __init__(self, bitrate=100000, ch_enable=True, ch_number=1, crc_key=0xFFFF, crc_polynomial=0x8005, debug_log=False, debug_log_verbosity=False, demod_dc_block_time=6e-3, dewhitening_key=0x1ff, fsk_deviation=60e3, lo_osc_freq=869.3e6, loop_bw=0.015, loop_damping=1.4, passband_end=85e3, power_offset_calib=-15, samp_rate=13e6, samp_rate_demod=260e3, selected_ch_freq=868.15e6, squelchAlpha=300e-3, squelch_level=-40, squelch_ramp=8, stop_band_attenuation_dB=96, stopband_start=95e3, ted_gain=1, ted_max_deviation=1.5):
        gr.hier_block2.__init__(
            self, "Verisure 4GFSK Radio Channel to Data Mesagge",
                gr.io_signature(1, 1, gr.sizeof_gr_complex*1),
                gr.io_signature.makev(15, 15, [gr.sizeof_gr_complex*1, gr.sizeof_gr_complex*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1, gr.sizeof_float*1]),
        )
        ...
        self.symbolrate = symbolrate = bitrate/2
        ...
        self.verisure_float_to_msg_resamp_ratio_converter = verisure_float_to_msg_resamp_ratio_converter.blk(decimation=2)
        ...
        self.digital_symbol_sync_xx_0 = digital.symbol_sync_ff(
            ...
            128,
            [])
        self.digital_correlate_access_code_tag_xx_0 = digital.correlate_access_code_tag_ff("1111011101011111110101110101011111110111010111111101011101010111", 0, "phyframe")
        ...
        self.blocks_multiply_const_xx_1_1 = blocks.multiply_const_ff(2, 1)
        ...
        self.connect((self.blocks_add_const_vxx_1_0, 0), (self.digital_correlate_access_code_tag_xx_0, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self.blocks_multiply_const_xx_1_1, 0))
        self.connect((self.blocks_char_to_float_0_0, 0), (self, 14))
        self.connect((self.blocks_char_to_float_0_0_0, 0), (self, 13))
        ...
        self.connect((self.blocks_multiply_const_xx_0_0, 0), (self, 10))
        self.connect((self.blocks_multiply_const_xx_0_0_0, 0), (self, 11))
        self.connect((self.blocks_multiply_const_xx_0_0_0_0, 0), (self.blocks_delay_0_0, 0))
        self.connect((self.blocks_multiply_const_xx_1_1, 0), (self.blocks_add_const_vxx_1_0, 0))
        ...
        self.connect((self.blocks_repeat_0, 0), (self.blocks_char_to_float_0_0_0, 0))
        ...
        self.connect((self.blocks_uchar_to_float_0, 0), (self, 9))
        self.connect((self.blocks_uchar_to_float_0_1_0, 0), (self, 12))
    ...
    def set_bitrate(self, bitrate):
        self.bitrate = bitrate
        self.set_symbolrate(self.bitrate/2)
