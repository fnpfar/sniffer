...
# Title: Constellation Decoder Test
# Author: Francisco Nicolás Pérez Fernández
# Copyright: 2022
# Description: Used to characterize the constellation decoder transfer function for a given constellation object.
...
class constellationDecoderTest(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Constellation Decoder Test", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Constellation Decoder Test")
        ...
        self.settings = Qt.QSettings("GNU Radio", "constellationDecoderTest")
        ...
        self.fourPamConstellation = fourPamConstellation = digital.constellation_calcdist([-1,-1/3,1/3,1], [0,1,2,3],
        ...
        labels = ['Decoder Input', 'Decoder Output', 'Signal 3', 'Signal 4', 'Signal 5',
        ...
        self.blocks_multiply_const_vxx_0_0 = blocks.multiply_const_ff(2/3)
        ...
        self.analog_sig_source_x_0 = analog.sig_source_c(samp_rate, analog.GR_TRI_WAVE, 500, 1, 0, 0)
        ...
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_float_to_complex_1, 0))
        self.connect((self.blocks_add_const_vxx_0, 0), (self.blocks_multiply_const_xx_0, 0))
...
def main(top_block_cls=constellationDecoderTest, options=None):
